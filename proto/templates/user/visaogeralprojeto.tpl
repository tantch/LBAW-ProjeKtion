			...
			<div id="wrapper">
				...
				<div id="page-wrapper">
									...
									<div class="panel-group" id="accordion">
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion"
														href="#collapseOne">{$cat.nomecat}</a>
												</h4>
											</div>
											...
											<div id="collapseOne" class="panel-collapse collapse in">
												...
												<div class="panel-body">
													<a href={$chore.idcat} data-toggle="tab">{$chore.nometarefa}
													</a>
												</div>
												{/if} {/foreach}
					...
					<div class="row">
						...
						<!-- /.col-lg-6 -->
						{/foreach} <br> <br> <a
							href="http://paginas.fe.up.pt/~ei12037/LBAW/proto/pages/user/forum.php?idprojeto={$idproj}">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="panel panel-default" id="editBox">
									<div class="panel-heading">Gerir permissões</div>
								</div>
							</div>
						</div>
						...
						<div class="panel-body">
							...
							<p class="text-center">
								{$roleUsers.username} - {$roleUsers.funcaoproj} {if role eq
								'Master'}
								<button type="button"
									class="btn btn-default btn-xs glyphicon glyphicon-name">Despromover
									a colaborador</button>

								{/if} {if $role neq 'Colaborador'}

								<button type="button" class="btn btn-default btn-xs">Promover a
									Coordenador</button>
								{/if}
							</p>
							{/foreach}
